    ...
    return (
        <section className="faqSection">
            ...
            <Accordion>
                ...
                <AccordionDetails>
                    <Typography>
                    BudgetBee helps you track your expenses and earnings while providing insights on how to better manage your funds. We offer tips on budgeting and financial planning based on your income and spending patterns.                    </Typography>
                </AccordionDetails>
            </Accordion>
            <Accordion>
                <AccordionSummary
